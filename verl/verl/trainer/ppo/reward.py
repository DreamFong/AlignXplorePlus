...
def load_reward_manager(config, tokenizer, num_examine, **reward_kwargs):
    ...
    elif reward_manager_name == "alignx":
        from verl.workers.reward_manager import AlignXploreRewardManager

        reward_manager_cls = AlignXploreRewardManager

    elif reward_manager_name == "streaming":
        from verl.workers.reward_manager import StreamingRewardManager

        reward_manager_cls = StreamingRewardManager
    else:
