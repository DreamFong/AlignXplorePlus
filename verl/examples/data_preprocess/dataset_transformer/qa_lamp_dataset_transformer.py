...
DATASET_CONFIGS = [
    {"config_name": "Art_and_Entertainment", "topic": "art_and_entertainment"},
    {
        "config_name": "Lifestyle_and_Personal_Development",
        "topic": "life_and_personal_development",
    },
    {"config_name": "Society_and_Culture", "topic": "society_and_culture"},
]

# Hugging Face 数据集名称
DATASET_HUB_NAME = "/ossfs/workspace/nas/yuting/data/LaMP-QA/"

# 输出目录和文件名
OUTPUT_DIR = "/ossfs/workspace/nas/yuting/data/LaMP-QA/"
...
def format_example(example, topic):
    ...
    output_str = example["rubric_aspects"]
...
def main():
    ...
    for config in DATASET_CONFIGS:
        ...
        # --- 处理验证集 ---
        val_split = load_dataset(DATASET_HUB_NAME, name=config_name, split="validation")
    ...
    with open("/ossfs/workspace/nas/yuting/data/LaMP-QA/statistics", "a+") as f:
        f.writelines(
