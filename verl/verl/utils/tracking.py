...
class Tracking:
    ...
    def __init__(
        ...
        if "tensorboard" in default_backend:
            exp_name = config["trainer"].get("experiment_name", "default")
            self.logger["tensorboard"] = _TensorboardAdapter(experiment_name=exp_name)
...
class _TensorboardAdapter:
    def __init__(self, experiment_name):
        ...
        tensorboard_dir = os.path.join(
            os.environ.get(
                "TENSORBOARD_DIR", "/ossfs/workspace/nas/yuting/tensorboard_log/"
            ),
